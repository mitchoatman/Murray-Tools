...
family_pathCC = r'C:\Egnyte\Shared\BIM\Murray CADetailing Dept\REVIT\FAMILIES\Duct Accessories\Sleeves\RWS.rfa'
...
def place_and_modify_family(duct, famsymb):
    ...
    set_parameter_by_name(new_family_instance, 'Width', width / 12)
    set_parameter_by_name(new_family_instance, 'Height', height / 12)  
