...
class LocationForm(Form):
    ...
    def InitializeComponents(self, default_value):
        ...
        # Label for TextBox
        self.label = Label()
        self.label.Text = "Enter Location:"
...
if value:
    ...
    if not selected_ids:
        ...
        try:
            picked_refs = uidoc.Selection.PickObjects(ObjectType.Element, "Please select elements to set Location.")
