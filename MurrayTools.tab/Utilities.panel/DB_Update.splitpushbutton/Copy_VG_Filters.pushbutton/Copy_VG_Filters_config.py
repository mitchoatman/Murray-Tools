...
def main():
    ...
    logger.info('Filters copied to all view templates')
    output = script.get_output()
    output.print_md('**Done.** All filters from the active view/template have been copied to **{}** view templates.'.format(len(viewtemplate_list)))
