...
FamilyName = 'Trimble Wall Sleeve'
FamilyType = 'Trimble Wall Sleeve'
# Check if the family is in the project
Fam_is_in_project = any(f.Name == FamilyName for f in families)
#print("Family '{}' is in project: {}".format(FamilyName, is_in_project))

family_pathCC = r'C:\Egnyte\Shared\BIM\Murray CADetailing Dept\REVIT\FAMILIES\Pipe Accessories\Sleeves\Trimble Wall Sleeve.rfa'
