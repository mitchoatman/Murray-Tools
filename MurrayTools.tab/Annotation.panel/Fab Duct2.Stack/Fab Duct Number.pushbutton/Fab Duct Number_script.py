...
__title__ = 'Fab Duct Number'
__doc__ = """This will Insert the Fabrication Duct Number Tag Family into the Active View.(If the Family is already loaded into the project)"""
...
FamilyName = 'Fabrication Duct - Number Tag'
FamilyType = 'Fabrication Duct - Number Tag'
# Check if the family is in the project
Fam_is_in_project = any(f.Name == FamilyName for f in families)
#print("Family '{}' is in project: {}".format(FamilyName, is_in_project))

family_pathCC1 = 'C:\Egnyte\Shared\BIM\Murray CADetailing Dept\REVIT\FAMILIES\Annotation\Fabrication Duct - Number Tag - Aligned.rfa'
family_pathCC2 = 'C:\Egnyte\Shared\BIM\Murray CADetailing Dept\REVIT\FAMILIES\Annotation\Fabrication Duct - Number Tag.rfa'

t = Transaction(doc, 'Load Duct Number Family')
#Start Transaction
t.Start()
...
symbName = 'Fabrication Duct - Number Tag'
