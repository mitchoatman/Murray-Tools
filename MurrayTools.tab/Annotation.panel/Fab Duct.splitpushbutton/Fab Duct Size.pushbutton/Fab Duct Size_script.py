...
__title__ = 'Fab Duct Size'
__doc__ = """This will Insert the Fabrication Duct Size Tag Family into the Active View.(If the Family is already loaded into the project)"""
...
FamilyName = 'Fabrication Duct - Size Tag'
FamilyType = 'Fabrication Duct - Size Tag'
# Check if the family is in the project
Fam_is_in_project = any(f.Name == FamilyName for f in families)
#print("Family '{}' is in project: {}".format(FamilyName, is_in_project))

family_pathCC1 = 'C:\Egnyte\Shared\BIM\Murray CADetailing Dept\REVIT\FAMILIES\Annotation\Fabrication Duct - Size Tag - Aligned.rfa'
family_pathCC2 = 'C:\Egnyte\Shared\BIM\Murray CADetailing Dept\REVIT\FAMILIES\Annotation\Fabrication Duct - Size Tag.rfa'

t = Transaction(doc, 'Load Duct Size Family')
#Start Transaction
t.Start()
