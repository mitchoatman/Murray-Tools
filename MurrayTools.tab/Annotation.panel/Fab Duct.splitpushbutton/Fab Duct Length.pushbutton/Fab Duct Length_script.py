...
__title__ = 'Fab Duct Length'
__doc__ = """This will Insert the Fabrication Duct Length Tag Family into the Active View.(If the Family is already loaded into the project)"""
...
FamilyName = 'Fabrication Duct - Duct Length Tag'
FamilyType = 'Fabrication Duct - Duct Length Tag'
...
symbName = 'Fabrication Duct - Duct Length Tag'
