...
for view in selected_views:
    ...
    if not scope_box_param:
        TaskDialog.Show("Error", "No scope box parameter found for ceiling plan '{}'. Please assign a scope box to all selected views.".format(view.Name))
        sys.exit()
...
for view in selected_views:
    ...
    for sheet in selected_sheets:
        ...
        for vp in viewports:
            ...
            existing_scope_box_param = existing_view.get_Parameter(BuiltInParameter.VIEWER_VOLUME_OF_INTEREST_CROP)
