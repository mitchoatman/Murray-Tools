...
# WPF Form (no XAML)
class REFBSDesignationForm(Window):
    def __init__(self, default_value):
        ...
        label = Label()
        label.Content = "Enter REF BS Designation:"
...
# Show dialog
form = REFBSDesignationForm(PrevInput)
value = None
...
if value:
    ...
    if not selected_ids:
        try:
            picked_refs = uidoc.Selection.PickObjects(ObjectType.Element, "Please select elements to set REF BS Designation.")
